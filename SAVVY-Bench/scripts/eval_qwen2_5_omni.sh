...
cp models/qwen2_5_omni.py third_party/lmms_eval/lmms_eval/models/qwen2_5_omni.py
...
# expected by spatial_avqa_doc_to_visual() and qwen2_5_omni.py.
...
bash scripts/eval_model_base.sh \
    --model qwen2_5_omni_7b \
    --num_processes 1 \
    --benchmark spatial_avqa \
    --output_path logs/qwen2_5_omni \
    --limit "${LIMIT:-}" 
